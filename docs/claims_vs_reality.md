...
### Why It Actually Works (The Reality)
We use a **Copy-on-Write (CoW)** branching coordinate database (`AdelicMemorySwapGridDB`).
...
* [Project Atlas Performance Whitepaper](file:///Volumes/Storage/project_atlas_unified/docs/project_atlas_whitepaper.md) — View the raw benchmark results.
* [Skeptics FAQ](file:///Volumes/Storage/project_atlas_unified/docs/skeptics_faq.md) — Direct answers to common criticisms.
* [QAN Accessible Overview](file:///Volumes/Storage/project_atlas_unified/docs/accessible_overview.md) — The subway system and postal code analogies.
