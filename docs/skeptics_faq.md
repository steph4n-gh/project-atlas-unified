...
* For the mathematical details, see [Mathematical Specifications](file:///Volumes/Storage/project_atlas_unified/docs/mathematical_specifications.md).
* For quick setup and run instructions, see [Entry Points](file:///Volumes/Storage/project_atlas_unified/docs/entry_points.md).
* For human-accessible analogies, see [QAN Accessible Overview](file:///Volumes/Storage/project_atlas_unified/docs/accessible_overview.md).
